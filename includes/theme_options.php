...
//微博及订阅设置
	...
	array(  "name" => "是否开启关注本站小工具",
	   ...
	   array("name" => "输入腾讯微博地址(包含http://)",
            ...
            "type" => "text",
            "std" => "http://t.qq.com/wondersland"),

       array("name" => "输入新浪微博地址(包含http://)",
            "desc" => "",
            "id" => $shortname."_sinamblog",
            "type" => "text",
            "std" => "http://weibo.com/yonghappy"),

       array("name" => "输入腾讯邮件订阅ID",
            "desc" => "",
            "id" => $shortname."_emailid",
            "type" => "text",
            "std" => "28744e000a94be0343dda1853c3b3a105890de8a4bff0a19"),

       array("name" => "输入Feed地址(包含http://)",
            "desc" => "",
            "id" => $shortname."_rsssub",
            "type" => "text",
            "std" => "http://feed.feedsky.com/yonghappy"),

       array("name" => "输入RSS订阅提示语",
            "desc" => "",
            "id" => $shortname."_rss",
            "type" => "textarea",
            "std" => "Hi! 使用主题有任何问题请到（http://www.yonghappy.com）交流O(∩_∩)O~"),
...
//"google自定义搜索
	...
	array(	"name" => "输入你的Google搜索结果页面链接",
			...
			"type" => "text",
			"std" => "http://www.yonghappy.com/search"),
...
?> <div class="wrap rm_wrap"> <h2><?php echo $themename; ?> 主题设置</h2> <p>当前使用主题: FengYun 2.1版 | 设计者:<a href="http://www.yonghappy.com"	target="_blank"> huishao</a> <font style="font-size:20px;"color=#ff0000><strong> &hearts; </strong></font> | <a href="http://www.yonghappy.com" target="_blank">查看主题更新</a> | </p> <div class="rm_opts"> <form method="post"> <?php foreach ($options	as $value) { switch ( $value['type']	) {
case "open": ?>
<?php break;
case "close": ?>
</div> </div> <br	/>
