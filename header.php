...
<?php include('includes/seo.php'); ?><meta http-equiv="Cache-Control" content="no-transform" /><meta http-equiv="Cache-Control" content="no-siteapp" />
...
<!-- PNG -->
<!--[if lte IE 6]> <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/ie6style.css" type="text/css" media="screen"> <![endif]-->
<!--[if lt IE 7]>
